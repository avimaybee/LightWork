            ...
            <div className={cn(
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="bottom">
                        <p>Best for high volume, simple tasks.</p>
                        <p className="opacity-70 mt-0.5">1M TPM limit. Lowest latency.</p>
                    </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                    ...
                    <TooltipContent side="bottom">
                        <p>Best for complex reasoning & creative tasks.</p>
                        <p className="opacity-70 mt-0.5">Higher fidelity. Slower generation.</p>
                    </TooltipContent>
                </Tooltip>
            </div>
        </TooltipProvider>
